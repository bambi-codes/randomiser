(() => {
  ...
  // src/content/entry.jsx
  var import_react = __toESM(require_react(), 1);
  var import_client = __toESM(require_client(), 1);

  // src/components/main-page.jsx
  var MainPage = () => {
    return /* @__PURE__ */ React.createElement("p", null, "Main Page");
  };
  var main_page_default = MainPage;

  // src/content/entry.jsx
  var NAV_SELECTOR = ".app-header .nav";
  var LINK_TEXT = "Playlist Randomiser";
  var ROUTE_PATH = "/randomiser";
  var MOUNT_ID = "randomiser-extension-root";
  var reactRoot = null;
  ...
  function createMount() {
    ...
    reactRoot = (0, import_client.createRoot)(mount);
    reactRoot.render(/* @__PURE__ */ import_react.default.createElement(main_page_default, null));
  }
